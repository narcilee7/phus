...
import { FileTree } from "../src/components/file-components/FileTree.js";

const wait = (ms = 100) => new Promise((r) => setTimeout(r, ms));

vi.mock("../src/components/command-components/CommandPalette.js", () => ({
  scanFiles: vi.fn(async () => ["src/index.ts", "src/lib/foo.ts", "README.md"]),
}));

vi.mock("../src/handler/git/git-status.js", () => ({
